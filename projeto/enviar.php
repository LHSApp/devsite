...
// Mudar Aqui o e-mail
$email_envio = "leandro@leandrohsantos.com.br"; // E-mail do site (ex: contato@seusite.com)
$email_pass = "35851279Br*"; // Senha do e-mail

$site_name = "Ghost"; // Nome do Site
$site_url = "www.leandrohsantos.com.br"; // URL do Site

$host_smtp = "smtp.leandrohsantos.com.br"; // HOST SMTP Ex: smtp.domain.com.br
